...
import { Menu, Search, Bell, HelpCircle, LogOut, Settings2, ChevronDown, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-2 bg-muted/50 rounded-lg px-3 py-2 max-w-sm">
